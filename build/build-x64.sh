...
ARCH="x64"
GOARCH="amd64"
OUTPUT="dist/ThunderUpdater-x64.exe"
SYSO="cmd/thunderupdater/resource_windows_amd64.syso"

echo "=== Build Windows $ARCH (64-bit) ==="
...
goversioninfo -icon=assets/icon.ico -o "$SYSO" cmd/thunderupdater/versioninfo.json
